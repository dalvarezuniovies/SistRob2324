...
Hr0=transl(0,-90,-10)*rotx(pi/2); %*rotx(pi/2);  %transl(0,-50,-10)*rotz(-pi/2)*rotx(pi/2);  %transl(195,-30,-5)*rotz(-pi/2)*rotx(pi/2);  %transl(0,-0,0)*rotz(-pi/2)*rotx(pi/2);  %transl(430,-430,0)*rotz(-pi/2)*rotx(pi/2); 
B0.setPose(Hr0);
